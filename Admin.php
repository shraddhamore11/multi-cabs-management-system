...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($username === "admin" && $password === "admin@123") {
        // Redirect to the next page for the admin
...
<div class="col-lg-6">
    <div class="position-relative mx-auto">
        <h1 class="text-primary mb-0">Admin Login</h1>
        <br>
        <br>
    </div>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div class="position-relative mx-auto">
			...
			<input name="username" class="form-control border-0 w-100 py-3 px-4 rounded-pill" type="text" placeholder="Username" required>
            <br>
            <br>
        </div>

        <div class="position-relative mx-auto">
            <input name="password" class="form-control border-0 w-100 py-3 px-4 rounded-pill" type="password" placeholder="Your Password" required>
            <br>
            <br>
        </div>

        <div class="position-relative mx-auto">
            <button class="form-control border-0 w-100 py-3 px-4 btn btn-dark" type="submit">Login</button>
        </div>
    </form>
</div>
