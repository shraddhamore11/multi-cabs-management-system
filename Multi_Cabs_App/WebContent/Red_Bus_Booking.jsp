...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="ViewRoute.jsp" class="nav-item nav-link">Route Details</a>
                <a href="ViewAllBooking.html" class="nav-item nav-link">Booking Details</a>
                <a href="AddStaff.html" class="nav-item nav-link">Add Staff</a>
                <a href="ViewStaff.jsp" class="nav-item nav-link">Staff Details</a>
    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-9.png);">
    ...
    <div class="container-xxl py-5">
        <div class="container">     
                ...
                <div class="form-body">
                        <form action="Red_Bus_Book"method="post">
					...
					String Staff_Email="yash@gmail.com";
