    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-12.png);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Staff Details</h1>
 ...
 <table class="table"border="1">
						  ...
						  <%
						  	try
						  	{
						  		...
						  		PreparedStatement ps = con.prepareStatement("select sr_no,Cab_Name,Staff_Name,Staff_Email,Mob from staff_info_tbl");
