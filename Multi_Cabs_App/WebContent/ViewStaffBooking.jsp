    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
          ...
          <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="ViewStaffBooking.jsp" class="nav-item nav-link"><b>My Bookings</b></a>
    ...
    <div class="row g3">
                                ...
                                <label><b>Enter Email :</b> </label>   
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="Staff_Email" placeholder="Staff_Email">
                        ...
                        <%
						 ...
						 %>
						 <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">View My Bookings</buttosn>
                                </div>
                            </div>
                            </div>
    <!-- Page Header End -->
   ...
   <table class="table"border="1">
						  ...
						  <%
						  	try
						  	{
						  	    ...
						  	    PreparedStatement ps = con.prepareStatement("select * from booking_tbl where Staff_Email=?");
